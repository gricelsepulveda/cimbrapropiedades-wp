...
<section class="cm-showcase">
  ...
  <?php
    ...
    $propCar = get_post_meta(get_the_ID(), 'propiedad-caracteristicas', true);
    $propKind = get_post_meta(get_the_ID(), 'propiedad-tipo', true);
    $propLoc = get_post_meta(get_the_ID(), 'propiedad-ubicacion', true);
